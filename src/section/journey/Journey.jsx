    ...
    <Box className={classes.root}>
      ...
      <Timeline>
        ...
        <JourneyItemPerm
          ...
          techStack="Java, Micronaut, Apache Kafka, RxJava, Vertx, Microsoft Azure, AWS, Groovy, Spock, Cucumber, Couchbase, Jenkins, Gradle, Git, Jira"
        ...
        <JourneyItemPerm
          ...
          techStack="TypeScript, Node JS, Jetbrains Webstorm, Android, Kotlin, RxKotlin, Android Studio, iOS, Swift, RxSwift, XCode, Google Cloud Platform, Serverless functions, Firestore, Circle CI, Terraform, Git, Yarn, Jira"
        ...
        <JourneyItemPerm
          ...
          techStack="Kotlin, Dropwizard, Ktor, PostgreSQL, Guice, Kodein, Github deployments, Jira, KoTest, MockK, Kubernetes, Postman, Amazon SQS, Amazon S3, Drone CI, Datadog, OpsGenie, Agile Methodology, Jetbrains IntelliJ, Git, Gradle"
        ...
        <JourneyItemPerm
          ...
          techStack="Java, MapR, Apache HBase, Apache Kafka, ElasticSearch, Dropwizard, JUnit, AssertJ, Mockito, Postman, Prometheus, Kubernetes, Jenkins CI, Gitlab, CI/CD pipeline, Agile, Git, Maven"
