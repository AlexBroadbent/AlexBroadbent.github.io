...
export const Blog = () => (
  <Section title="Blog">
    ...
    >
      The client, Handmade in Harpenden, have multiple streams of revenue, varying from B2C and B2B,
      which made it difficult for the team to capture accurate sales in real time…
    </BlogItem>
    <BlogItem
    ...
    >
      Here are my highlights from this year’s conference if you missed it. It’s clear there has been
      a lot of excitement around the future of Java version 18 and this conference was no
    ...
    >
      ...
      numbers to make them unique for the test case. This became a repetitive task that strained my
      fingers from hitting copy and paste too much…
    </BlogItem>
    <BlogItem
    ...
    >
      There are different types of questions that are asked in Software Engineering interviews which
      are aimed to only be answered by more experienced developers and then there are questions that
      differentiate candidates based on the detail they give…
    </BlogItem>
    <BlogItem
    ...
    >
      After working in the backend JVM world for 5 years, there were a lot of interesting challenges
      when moving from a backend engineer position at Flux to a full-stack engineer role at
      Freetrade (where I currently work)…
    </BlogItem>
