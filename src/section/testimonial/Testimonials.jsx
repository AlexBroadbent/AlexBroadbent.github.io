  ...
  <Section title="Testimonials">
    ...
    >
      <Typography variant="body1" paragraph>
        ...
        dashboard. He is extremely patient and understanding, with an exceptional ability to convert
        technical knowledge into business speak. He kept us in the loop with progress during the
        project and provided regular updates for feedback.
      </Typography>
      <Typography variant="body1" paragraph>
